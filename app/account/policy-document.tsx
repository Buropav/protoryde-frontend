      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            Coverage activates automatically when the recorded rainfall exceeds 15mm per hour or ambient temperature rises above 45°C within your active delivery zone. Data is verified via recognized meteorological networks.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            Payouts are processed instantly to your linked bank account via IMPS/UPI. Minimum verification time from the trigger incident is approximately 30 minutes to reduce fraudulent readings.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            If you believe a claim should have been triggered but wasn't, you can request a manual audit within 48 hours of the associated incident.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  section: { backgroundColor: Colors.cardFill, padding: 16, borderRadius: 12, borderColor: Colors.border, borderWidth: 1, marginBottom: 16 },
