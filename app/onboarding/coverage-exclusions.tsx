...
import { View, Text, StyleSheet, Pressable, ScrollView, Dimensions, LayoutAnimation, UIManager, Platform } from 'react-native';
...
const EXCLUSION_GROUPS = [
  ...
  },
  {
    ...
    items: ['Coverage does not apply to non-weather related app outages, server downtime, or lack of orders.']
  },
  {
    id: 'bans',
    title: 'Third-Party App Bans',
    items: ['Loss of income due to account suspension, deactivation, or temporary bans by the gig platform.']
  },
  {
    id: 'international',
    title: 'International Incidents',
    items: ['Coverage is limited to events within your specified active coverage zone and country.']
  }
];
...
export default function CoverageExclusionsScreen() {
  ...
  const [viewedGroups, setViewedGroups] = useState<Set<string>>(new Set(['bodily']));
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
          <Text style={styles.title}>What ProtoRyde Covers{'\n'}(and Doesn't)</Text>
          <Text style={styles.subtitle}>Review our coverage boundaries before activating your protection.</Text>
          ...
          <View style={styles.coreTriggersRow}>
            <View style={styles.triggerCard}>
              ...
              <Ionicons name="cloud-download" size={24} color={Colors.primary} style={styles.triggerIcon} />
              <Text style={styles.triggerTitle}>Heavy Rainfall</Text>
              <Text style={styles.triggerValue}>≥ 30mm / 24h</Text>
            </View>
            <View style={styles.triggerCard}>
              <View style={styles.triggerCardLine} />
              <Feather name="sun" size={24} color={Colors.primary} style={styles.triggerIcon} />
          ...
          <View style={[styles.sectionHeader, { marginTop: 32 }]}>
            ...
            <Text style={[styles.sectionTitle, { color: '#FF8A80' }]}>WHAT'S NOT COVERED</Text>
          </View>
            ...
            {EXCLUSION_GROUPS.map((group) => {
              ...
              return (
                <View key={group.id} style={styles.exclusionGroup}>
                  <Pressable 
                    style={[styles.exclusionHeader, isExpanded && styles.exclusionHeaderExpanded]} 
                    onPress={() => toggleExpand(group.id)}
                  >
                    <Text style={styles.exclusionGroupTitle}>{group.title}</Text>
                    <Feather 
          ...
          <View style={styles.understandingBox}>
            ...
            <View style={styles.understandingTextCol}>
              <Text style={styles.understandingTitle}>I have read and understood the above exclusions.</Text>
              {!allViewed && (
                <Text style={styles.understandingWarning}>Please review all exclusion groups above first.</Text>
              )}
            </View>
          </View>
      ...
      <View style={styles.footer}>
        ...
        >
          <Text style={[styles.buttonText, !allViewed && styles.buttonTextDisabled]}>I Understand and Accept</Text>
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: '700', color: Colors.textPrimary, marginBottom: 12, letterSpacing: -0.5, lineHeight: 34 },
