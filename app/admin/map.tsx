...
const MapView =
  Platform.OS === "web" ? View : require("react-native-maps").default;
const Marker =
  Platform.OS === "web" ? View : require("react-native-maps").Marker;
      ...
      <View style={styles.container}>
        <View style={styles.webMapPlaceholder}>
          ...
          <Text style={styles.placeholderSubtitle}>
            Native maps are disabled in this environment.
          </Text>
              ...
              <View
                ...
                style={[
                  styles.mockMarker,
                  {
                    ...
                    backgroundColor: claim.fraud_check_passed
                      ? Colors.success
                      : Colors.error,
                  },
                ]}
