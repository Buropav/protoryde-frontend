...
export default function AdminDashboard() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      >
        <View>
          ...
          <Text style={styles.navDesc}>
            Visualize claim density across zones
          </Text>
        </View>
      ...
      <Pressable
        style={styles.navCard}
        onPress={() => router.push("/admin/fraud" as any)}
      >
        <View>
          <Text style={styles.navTitle}>🔍 Fraud Audit</Text>
          <Text style={styles.navDesc}>
            Review flagged claims and ML outliers
          </Text>
        </View>
        <Text style={styles.navArrow}>→</Text>
      </Pressable>
      ...
      <Pressable
        style={[styles.navCard, { marginTop: 40, borderColor: Colors.error }]}
        onPress={() => router.replace("/(tabs)" as any)}
      >
        <Text style={[styles.navTitle, { color: Colors.error }]}>
          Exit Admin Mode
        </Text>
      </Pressable>
    </ScrollView>
