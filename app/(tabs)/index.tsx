...
import { CurrentPolicyResponse, RiderCalendarResponse, WeatherCurrentResponse } from '../../src/types/api';
...
export default function HomeScreen() {
  ...
  const isTriggerActive = !!weather?.trigger_view && Object.values(weather.trigger_view).some(t => t.breached);
      ...
      >
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statCard}>
            ...
            <Text style={[styles.statValue, isPolicyActive ? styles.statusActive : styles.statusInactive]}>
        ...
        {isTriggerActive && (
          <View style={styles.alertCard}>
            ...
            <Text style={styles.alertText}>
              Extreme conditions detected in {zone}. Click below to confirm location and start check-in.
            </Text>
...
const styles = StyleSheet.create({
  ...
  alertCard: { backgroundColor: 'rgba(255, 149, 0, 0.1)', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: Colors.alert, marginBottom: 24 },
  ...
  actionButton: { backgroundColor: Colors.alert, paddingVertical: 12, borderRadius: 8, alignItems: 'center' },
